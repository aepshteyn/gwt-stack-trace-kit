...
/**
 * Mixes in the behavior of JsSuperVisitor with JsModVisitor.
 *
 * Since Java doesn't support multiple inheritance, we have to fully
 * duplicate the code in JsSuperVisitor here.
 */
public class JsSuperModVisitor extends JsModVisitor {
