...
/**
 * This cache stores {@link com.google.gwt.dev.javac.CompilationUnit} instances in a Map.
 *
...
class MemoryUnitCache implements UnitCache {
  ...
  /**
   * Track how the unit was loaded. Useful in {@link com.google.gwt.dev.javac.PersistentUnitCache} for
  ...
  /**
   * References to all {@link com.google.gwt.dev.javac.CompilationUnit} objects loaded from the
  ...
  protected final Map<String, UnitCacheEntry> unitMap = Collections
      .synchronizedMap(new ReferenceMap(AbstractReferenceMap.HARD, AbstractReferenceMap.HARD));

  /**
   * References {@link com.google.gwt.dev.javac.CompilationUnit} objects by {@link com.google.gwt.dev.javac.ContentId}, which is
