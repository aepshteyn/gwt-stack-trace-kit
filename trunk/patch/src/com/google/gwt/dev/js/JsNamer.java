...
public abstract class JsNamer {
  ...
  protected static Set<JsName> collectReferencedNames(JsProgram program) {
  ...
  /** Visits all JsName usages in the program */
  protected abstract static class RefVisitor extends JsVisitor {
    @Override
    ...
    protected abstract void doAddReference(JsName name);
  }
