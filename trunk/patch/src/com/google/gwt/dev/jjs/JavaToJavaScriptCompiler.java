...
public class JavaToJavaScriptCompiler {
  ...
  public static PermutationResult compilePermutation(TreeLogger logger, UnifiedAst unifiedAst,
    ...
    try {
       ...
       */
      SymbolMapsLinker.FilenameDeobfuscationArtifact filenameDeobfuscationArtifact
          = JsStackEmulator.exec(jprogram, jsProgram, propertyOracles, jjsmap, permutation);
      ...
      if (filenameDeobfuscationArtifact != null) {
        toReturn.addArtifacts(Lists.create(filenameDeobfuscationArtifact));
      }
